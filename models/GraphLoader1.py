                    ...
                    if speaker.count('.') + speaker.count('!') + speaker.count('?') > 0:
                        ...
                        for i, index in enumerate(split_index):
                            if i == 0:
                                ...
                                utterance_emotion.append(emo_caught(' '.join(speaker[:index + 1])))
                            else:
                                utterance.append(speaker[split_index[i - 1] + 1: index + 1])
                                utterance_emotion.append(emo_caught(' '.join(speaker[split_index[i - 1] + 1: index + 1])))
                        ...
                        if len(speaker[split_index[-1] + 1:]) != 0:
                            ...
                            utterance_emotion.append(emo_caught(' '.join(speaker[split_index[-1] + 1:])))
                    else:
                        utterance.append(speaker)
                        utterance_emotion.append(emo_caught(' '.join(speaker)))
...
def load_dataset():
    ...
    cache_file = f"{data_dir}/dataset_emotionflow.p"
